...
/*
 * ddos_note: Modified on top of SimSettings, mainly for processing new app feature from xml file
 */

public class DdosSimSettings {
	private static DdosSimSettings instance = null;
	...
	private DdosSimSettings() {
		NUM_OF_PLACE_TYPES = 0;
	}

	public static DdosSimSettings getInstance() {
		if(instance == null) {
			instance = new DdosSimSettings();
		}
		return instance;
	}
	...
	public static void setInstance(DdosSimSettings instance) {
		DdosSimSettings.instance = instance;
	}
	...
	private void parseApplicationsXML(String filePath)
	{
		...
		try {	
			...
			"finish_period" //ddos_note: new app feature
			};
			...
			DdosSimLogger.printLine("Edge Devices XML cannot be parsed! Terminating simulation...");
			e.printStackTrace();
			System.exit(1);
		}
	}
