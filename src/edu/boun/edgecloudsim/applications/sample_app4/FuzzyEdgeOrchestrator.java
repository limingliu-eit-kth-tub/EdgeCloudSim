...
public class FuzzyEdgeOrchestrator extends EdgeOrchestrator {
	...
	public void initialize() {
		...
		try {
			...
			DdosSimLogger.printLine("Cannot generate FIS! Terminating simulation...");
			e.printStackTrace();
			System.exit(0);
		}
	}
	...
	public int getDeviceToOffload(Task task) {
		...
		if(simScenario.equals("SINGLE_TIER")){
			...
			double manDelay = SimManager.getInstance().getNetworkModel().getUploadDelay(DdosSimSettings.GENERIC_EDGE_DEVICE_ID,
					DdosSimSettings.GENERIC_EDGE_DEVICE_ID, dummyTask /* 1 Mbit */);
			...
			if(policy.equals("FUZZY_BASED")){
				...
				*/
				...
				double delay_sensitivity = DdosSimSettings.getInstance().getTaskLookUpTable()[task.getTaskType()][12];
		        ...
		        */
	        	...
	        	double videoExecution = DdosSimSettings.getInstance().getTaskLookUpTable()[task.getTaskType()][12];
